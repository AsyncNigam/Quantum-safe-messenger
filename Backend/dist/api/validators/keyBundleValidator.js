...
exports.validateKeyBundle = exports.keyBundleSchema = void 0;
 ...
 */
exports.keyBundleSchema = zod_1.z.object({
    x25519PublicKey: zod_1.z.string().min(44).regex(base64Regex, 'Must be Base64 encoded'),
    mlKemPublicKey: zod_1.z.string().min(44).regex(base64Regex, 'Must be Base64 encoded'),
    ed25519Signature: zod_1.z.string().min(44).regex(base64Regex, 'Must be Base64 encoded'),
    mlDsaSignature: zod_1.z.string().min(44).regex(base64Regex, 'Must be Base64 encoded'),
});
/**
 ...
 */
const validateKeyBundle = (req, res, next) => {
    const result = exports.keyBundleSchema.safeParse(req.body);
    if (!result.success) {
        res.status(400).json({
...
exports.validateKeyBundle = validateKeyBundle;
//# sourceMappingURL=keyBundleValidator.js.map